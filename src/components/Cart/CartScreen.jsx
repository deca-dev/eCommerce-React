...
const CartScreen = () => {
  ...
  return (
    ...
    <div className='cart'>
    <h2 className='my-cart-header'>My Cart</h2>
    <div>
      {
    ...
    <div className='cart-footer-container'>
      <div className='cart-footer-container__total-section'>
        {
          cart ?
            <div className='cart-footer-container__total-section'>
              <span className='cart-footer-total-subtitle'>Total:</span>
              <span className='cart-footer-total-number'>${totalPriceCart}</span>
            </div>
            :
      ...
      <div className='cart-footer-button-container'>
        <button className='cart-footer-button' onClick={postPurchase}>
